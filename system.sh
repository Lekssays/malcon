...
export ORG11_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org11.example.com/peers/peer0.org11.example.com/tls/ca.crt
export ORG12_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org12.example.com/peers/peer0.org12.example.com/tls/ca.crt
export ORG13_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org13.example.com/peers/peer0.org13.example.com/tls/ca.crt
export ORG14_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org14.example.com/peers/peer0.org14.example.com/tls/ca.crt
export ORG15_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org15.example.com/peers/peer0.org15.example.com/tls/ca.crt
export ORG16_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org16.example.com/peers/peer0.org16.example.com/tls/ca.crt
export ORG17_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org17.example.com/peers/peer0.org17.example.com/tls/ca.crt
export ORG18_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org18.example.com/peers/peer0.org18.example.com/tls/ca.crt
export ORG19_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org19.example.com/peers/peer0.org19.example.com/tls/ca.crt
export ORG20_TLS_ROOTCERT_FILE=$PROJECT_DIRECTORY/network/crypto-config/peerOrganizations/org20.example.com/peers/peer0.org20.example.com/tls/ca.crt
...
function generateBlocks() {
  ...
  configtxgen -outputBlock genesis.block -profile TwentyOrgsOrdererGenesis -channelID system-channel -configPath=.

  echo "Generating channel block..."
  configtxgen -profile TwentyOrgsChannel -outputCreateChannelTx $CHANNEL_NAME.tx -channelID $CHANNEL_NAME -configPath=.
}
